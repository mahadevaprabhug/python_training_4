...
try:
    import requests
    my_api_response = requests.get("http://127.0.0.1:5000/mydbapi")
...
try:
    import requests
    my_api_response = requests.post("http://127.0.0.1:5000/mydbapi",
                                    json={
                                        "IP":"124.124.124.124",
                                        "PICS": "abc.jpg"
                                    }
...
print("PUT: Update existing RECORD")
print("-"*20)
# --------------

try:
    import requests
    my_api_response = requests.put("http://127.0.0.1:5000/mydbapi",
                                    json={
                                        "IP":"124.124.124.124",
                                        "PICS": "mmmmm.jpg"
                                    }
...
print("DELETE: Delete existing RECORD")
print("-"*20)
# --------------

try:
    import requests
    my_api_response = requests.delete("http://127.0.0.1:5000/mydbapi",
                                    json={
                                        "IP":"124.124.124.124",
                                        "PICS": "mmmmm.jpg"
                                    }
